...
--
-- Host: localhost    Database: taller1.2
-- ------------------------------------------------------
...
CREATE TABLE `reparacion` (
  ...
  `costo_repar` decimal(10,2) NOT NULL,
  ...
  KEY `idrep_idx` (`idrep`),
  KEY `idcli_idx` (`idcli`),
  CONSTRAINT `idcli` FOREIGN KEY (`idcli`) REFERENCES `cliente` (`idcli`),
...
CREATE TABLE `repuesto` (
  ...
  CONSTRAINT `fk_repuesto_iddist` FOREIGN KEY (`iddist`) REFERENCES `distribuidora` (`iddist`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-09-22 22:44:07
